...
alias brewfile='atom ~/.brewfile/ejointjp_brewfile/Brewfile'
...
alias phpini='atom /usr/local/etc/php/7.2/php.ini'
...
alias httpdconf='atom /usr/local/etc/httpd/httpd.conf'
alias vhostsconf='atom /usr/local/etc/httpd/extra/httpd-vhosts.conf'
