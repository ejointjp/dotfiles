...
alias setphpini55='mv /opt/homebrew/etc/php/5.5/php.ini /opt/homebrew/etc/php/5.5/php.ini.original && ln -s ~/Dropbox/Sites/apache/5.5/php.ini /opt/homebrew/etc/php/5.5/php.ini'
alias setphpini56='mv /opt/homebrew/etc/php/5.6/php.ini /opt/homebrew/etc/php/5.6/php.ini.original && ln -s ~/Dropbox/Sites/apache/5.6/php.ini /opt/homebrew/etc/php/5.6/php.ini'
alias sethttpdconf24='mv /opt/homebrew/etc/apache2/2.4/httpd.conf /opt/homebrew/etc/apache2/2.4/httpd.conf.original && ln -s ~/Dropbox/Sites/apache/2.4/httpd.conf /opt/homebrew/etc/apache2/2.4/httpd.conf'
alias setvhostsconf24='mv /opt/homebrew/etc/apache2/2.4/extra/httpd-vhosts.conf //opt/homebrew/etc/apache2/2.4/extra/httpd-vhosts.conf.original && ln -s ~/Dropbox/Sites/apache/2.4/httpd-vhosts.conf /opt/homebrew/etc/apache2/2.4/extra/httpd-vhosts.conf'
...
alias phpini55='atom /opt/homebrew/etc/php/5.5/php.ini'
alias hosts='sudo atom /etc/hosts'
alias httpdconf24='atom /opt/homebrew/etc/apache2/2.4/httpd.conf'
alias vhostsconf24='atom /opt/homebrew/etc/apache2/2.4/extra/httpd-vhosts.conf'
